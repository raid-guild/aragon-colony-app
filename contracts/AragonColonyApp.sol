...
contract AragonColonyApp is AragonApp {
    bytes32 public constant MOVE_FUNDS_ROLE = keccak256("MOVE_FUNDS_ROLE");
    ...
    function moveFundsBetweenPots(
        ...
        // uint256 permissionDomainSkillId = client
        //     .getDomain(permissionDomainId)
        //     .skillId;
        ...
        // uint256[] childSkills = network
        //     .getSkill(permissionDomainSkillId)
        //     .children;
